...
<div class="row py-4">
  <div class="col-12 mb-3">
    ...
    <ul class="nav nav-pills">
      ...
      <li class="nav-item"><a class="nav-link" href="/admin/project">المشاريع</a></li>
      <li class="nav-item"><a class="nav-link" href="/admin/project/create">انشاء مشروع</a></li>
    </ul>
  </div>
