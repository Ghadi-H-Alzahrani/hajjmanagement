...
<body>
  ...
  <div class="col-12 mb-3">
    ...
    <ul class="nav nav-pills">
      ...
      <li class="nav-item"><a class="nav-link" href="/engineer/sh/tasks">المهام</a></li>

    </ul>
  </div>
<nav class="navbar fixed-top navbar-expand-lg">
  <div class="container-fluid">
    <a class="navbar-brand" href="/engineer/dashboard">نظام الإدارة</a>

    <div class="d-flex gap-2 align-items-center">
      <a class="btn btn-sm btn-outline-secondary" href="/engineer/dashboard"><i class="bi bi-house-door"></i> لوحة</a>
      <a class="btn btn-sm" style="background:var(--purple-500); color:white" href="/engineer/tasks"><i class="bi bi-list-check"></i> المهام</a>
    </div>
  </div>
</nav>
