...
<nav class="navbar fixed-top navbar-expand-lg">
  <div class="container-fluid">
    <a class="navbar-brand" href="/admin/dashboard">نظام الإدارة</a>

    <div class="d-flex gap-2 align-items-center">
      <a class="btn btn-sm btn-outline-secondary" href="/admin/dashboard"><i class="bi bi-house-door"></i> لوحة</a>
      <a class="btn btn-sm" style="background:var(--purple-500); color:white" href="/admin/project"><i class="bi bi-list-check"></i> المشاريع </a>
    </div>
  </div>
</nav>
